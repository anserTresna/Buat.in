                        ...
                        <div id="menu" class="text-left ">
                            <ul class="offcanvas_main_menu">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="http://127.0.0.1:8000/productdetails">product</a>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="#">pages </a>
                                    <ul class="sub-menu">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="logo">
                                <a href="http://127.0.0.1:8000/home"><img src="assets/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="main_menu menu_position"> 
                                <nav>  
                                    <ul>
                                        ...
                                        <li><a href="http://127.0.0.1:8000/productdetails">Product</a></li>
                    ...
                    <div class="widgets_container widget_menu">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="http://127.0.0.1:8000/contact">Privacy Policy</a></li>
