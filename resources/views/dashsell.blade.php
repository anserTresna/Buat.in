            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="#revenue-chart" datatoggle="tab">Area</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#sales-chart" datatoggle="tab">Donut</a>
                        </li>
                    </ul>
                </div>
            </div><!-- /.card-header -->
        ...
        <div class="card direct-chat direct-chat-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <button type="button" class="btn btn-tool" data-cardwidget="collapse">
                        <i class="fas fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-tool" title="Contacts" datawidget="chat-pane-toggle">
                        <i class="fas fa-comments"></i>
                    </button>
                    <button type="button" class="btn btn-tool" data-cardwidget="remove">
                            ...
                            <a href="#">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name">
                                        Count Dracula
                                        <small class="contacts-list-date floatright">2/28/2015</small>
                                    </span>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name">
                                        Sarah Doe
                                        <small class="contacts-list-date floatright">2/23/2015</small>
                                    </span>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name">
                                        Nadia Jolie
                                        <small class="contacts-list-date floatright">2/20/2015</small>
                                    </span>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name">
                                        Nora S. Vans
                                        <small class="contacts-list-date floatright">2/10/2015</small>
                                    </span>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name">
                                        John K.
                                        <small class="contacts-list-date floatright">1/27/2015</small>
                                    </span>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name">
                                        Kenneth M.
                                        <small class="contacts-list-date floatright">1/4/2015</small>
                                    </span>
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <ul class="pagination pagination-sm">
                        <li class="page-item"><a href="#" class="pagelink">&laquo;</a></li>
                        <li class="page-item"><a href="#" class="page-link">1</a></li>
                        <li class="page-item"><a href="#" class="page-link">2</a></li>
                        <li class="page-item"><a href="#" class="page-link">3</a></li>
                        <li class="page-item"><a href="#" class="pagelink">&raquo;</a></li>
                    </ul>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                    ...
                    <li>
                        ...
                        <span class="text">Let theme shine like a star</span>
                        <small class="badge badge-secondary"><i class="far faclock"></i> 1 month</small>
                        <div class="tools">
                            <i class="fas fa-edit"></i>
                            <i class="fas fa-trash-o"></i>
                        </div>
    ...
    <section class="col-lg-5 connectedSortable">
        ...
        <div class="card bg-gradient-primary">
            <div class="card-header border-0">
                ...
                <div class="card-tools">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" data-cardwidget="collapse" title="Collapse">
                        <i class="fas fa-minus"></i>
                    </button>
                </div>
                <!-- /.card-tools -->
        ...
        <div class="card bg-gradient-info">
            <div class="card-header border-0">
                ...
                <div class="card-tools">
                    <button type="button" class="btn bg-info btn-sm" data-cardwidget="collapse">
                        <i class="fas fa-minus"></i>
                    </button>
                    <button type="button" class="btn bg-info btn-sm" data-cardwidget="remove">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
            </div>
        ...
        <div class="card bg-gradient-success">
            <div class="card-header border-0">
                ...
                <div class="card-tools">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-success btn-sm dropdowntoggle" data-toggle="dropdown"
                            data-offset="-52">
                    ...
                    <button type="button" class="btn btn-success btn-sm" data-cardwidget="collapse">
                        <i class="fas fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-success btn-sm" data-cardwidget="remove">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <!-- /. tools -->
